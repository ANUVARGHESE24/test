        ...
        for i in match:
            ...
            if i.expiry_date:
                ...
                if date_now >= exp_date:
                    ...
                    mail_content = "  Hello  " + i.employee_ref.name + ",<br>Your Document  %s " % i.name + " is going to expire on " + \
                                   str(i.expiry_date) + ". Please renew it before expiry date.<br><br>Thanks."
                    main_content = {
                    ...
                    message = self.env['mail.mail'].sudo().create(main_content)
                    message.send()
