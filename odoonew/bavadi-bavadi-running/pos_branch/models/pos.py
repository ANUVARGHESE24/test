...
class res_branch(models.Model):
	...
	address = fields.Char('Address', size=252)
	...
	# 	result = []
	# 	for branch in self:
	# 		arabic_name = str(branch.arabic_name )+ ',' + str(branch.address )+ '-' + str(branch.telephone_no)
	# 		result.append((branch.id, arabic_name))
	# 		return result
...
class pos_session(models.Model):
	...
	branch_address = fields.Many2one('res.branch', string='Branch Address')
