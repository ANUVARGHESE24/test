...
class ResConfigSettings(models.TransientModel):
    ...
    def _default_op_unit(self):
        ...
        print("Current op unit is: ", self.env.context.get('opid'))
        if opid:
    ...
    group_op_unit_in_journal_lines = fields.Boolean("Operating Unit field in Journal lines", implied_group="multi_op_unit.group_op_unit_in_journal_lines")
