...
class HrLoan(models.Model):
    ...
    name = fields.Char(string="Loan Name",default=lambda self: 'LOAN/', readonly=True, help="Name of the loan")
    ...
    def create(self, values):
        ...
        if loan_count:
            ...
            values['name'] = self.env['ir.sequence'].get('hr.loan.seq') or 'LOAN/ '
