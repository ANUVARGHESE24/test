...
class AssetDepreciationReportWizard(models.TransientModel):
    ...
    def get_xlsx_report(self):
        ...
        self.env.ref('account_asset_depreciation.depreciation_report_excel').report_file = "AssetDepreciation"
        return self.env.ref('account_asset_depreciation.depreciation_report_excel').report_action(self, data=data)
