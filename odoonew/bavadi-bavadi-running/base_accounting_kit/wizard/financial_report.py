...
class FinancialReport(models.TransientModel):
    ...
    def view_report_pdf(self):
        ...
        return self.env.ref(
            'base_accounting_kit.financial_report_pdf').with_context(
    ...
    def get_xlsx_report(self):
        ...
        data['report_lines'] = report_lines
        # checking view type
        self.env.ref('base_accounting_kit.financial_report_excel').report_file = "Financial_Report"
        return self.env.ref(
            'base_accounting_kit.financial_report_excel').report_action(self, data)
