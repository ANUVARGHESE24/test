...
class BankBookWizard(models.TransientModel):
    ...
    def _build_contexts(self, data):
        ...
        result['operating_unit'] = data['form']['operating_unit'] or False
    ...
    def check_report(self):
        ...
        if not self.account_ids:
            raise UserError(_("There is no  Bank account Ids "))
        data = {}
    ...
    def get_xlsx_report(self):
        ...
        data['form']['used_context'] = dict(used_context,
                                            lang=self.env.context.get(
                                                'lang') or 'en_US')
        self.env.ref('base_accounting_kit.action_report_bank_book_excel').report_file = "Bank_Book_Report"
        return self.env.ref(
            'base_accounting_kit.action_report_bank_book_excel').report_action(self,
                                                                               data=data)
